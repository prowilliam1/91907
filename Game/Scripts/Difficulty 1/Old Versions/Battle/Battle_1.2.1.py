...
character2_image = pygame.image.load("Graphics\\Characters\\Example 3.png")  # Add your own image path
character3_image = pygame.image.load("Graphics\\Characters\\Example 4.png")  # Add your own image path
character4_image = pygame.image.load("Graphics\\Characters\\Example 5.png")  # Add your own image path
...
current_level = 1
player_stats = get_player1_stats(current_level)
...
def draw_player_hp():
    bar_img = get_health_bar_image_for_enemy({"hp": player_hp, "max_hp": player_stats["hp"]})
    bar_x = 24
    bar_y = 24
    screen.blit(bar_img, (bar_x, bar_y))
    hp_text = font.render(f"{player_hp} / {player_stats['hp']}", True, (255, 255, 255))
...
def draw_ui():
    if not target_select_mode and not timer_active:
